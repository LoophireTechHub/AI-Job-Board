...
import JobPostingManager from '@/components/recruiter/job-posting-manager';
import ApplicantReview from '@/components/recruiter/applicant-review';
import AIScreeningTool from '@/components/recruiter/ai-screening-tool';
    ...
    return (
          <div className="min-h-screen bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        <div className="mb-8">
                                  <h1 className="text-3xl font-bold text-gray-900">Recruiter Dashboard</h1>h1>
