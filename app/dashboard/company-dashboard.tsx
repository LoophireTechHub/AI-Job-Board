...
import JobPostingManager from '@/components/company/job-posting-manager';
import ApplicantReview from '@/components/company/applicant-review';
import AIScreeningTool from '@/components/company/ai-screening-tool';
